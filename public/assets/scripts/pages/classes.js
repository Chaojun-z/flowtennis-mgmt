...
function openClassDetail(id){
  ...
  const footer=`<button class="tms-btn tms-btn-default" onclick="closeModal()">关闭</button><button class="tms-btn tms-btn-ghost" onclick="openClassScheduleList('${c.id}')">去排课表排课</button><button class="tms-btn tms-btn-primary" onclick="openClassModal('${c.id}')">编辑班次</button>`;
