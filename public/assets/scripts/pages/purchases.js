...
function openPurchaseEditModal(id){
  ...
  if(ownershipLocked||locked){
    ['pur_edit_studentId_dropdown','pur_edit_packageId_dropdown','pur_edit_ownerCoach_dropdown','pur_edit_saleCampusId_dropdown'].forEach(id=>{
  ...
  if(locked){
    const payMethodEl=document.getElementById('pur_edit_payMethod_dropdown');
    if(payMethodEl){payMethodEl.style.pointerEvents='none';payMethodEl.style.opacity='0.6';}
