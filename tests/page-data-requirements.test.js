...
assert.match(source, /if\(name==='financePage'\)\{[\s\S]*setDatasetValue\('campuses',data\.campuses\|\|\[\]\);[\s\S]*setDatasetValue\('students',data\.students\|\|\[\]\);[\s\S]*setDatasetValue\('schedule',data\.schedule\|\|\[\]\);[\s\S]*setDatasetValue\('entitlements',data\.entitlements\|\|\[\]\);[\s\S]*setDatasetValue\('entitlementLedger',data\.entitlementLedger\|\|\[\]\);[\s\S]*setDatasetValue\('financialLedger',data\.financialLedger\|\|\[\]\);[\s\S]*setDatasetValue\('financeRows',data\.financeRows\|\|\[\]\);[\s\S]*financeOverviewData=data\.financeOverview\|\|null;[\s\S]*financeAuditData=data\.financeAudit\|\|null;[\s\S]*setDatasetValue\('coaches',data\.coaches\|\|\[\]\);[\s\S]*setDatasetValue\('products',data\.products\|\|\[\]\);[\s\S]*setDatasetValue\('purchases',data\.purchases\|\|\[\]\);[\s\S]*setDatasetValue\('packages',data\.packages\|\|\[\]\);/, 'finance aggregate loader should hydrate normalized finance rows, overview and audit together with report dependencies');
